...
server.listen(PORT, HOST, () => {
  console.log(`Convergence running at http://${HOST}:${PORT}`);
});
            ...
            content: [
              {
                type: "input_text",
                text:
                  "You are helping summarize symptom overlap and possible diet considerations for multiple serious health conditions. Do not diagnose. Do not claim a treatment plan is medically correct. Produce cautious, structured guidance meant for discussion with a clinician. Return strict JSON with keys: summary, dietConsiderations, clinicianQuestions, safetyNotes. summary must be a string. The other keys must be arrays of short strings."
              }
            ]
          },
          {
